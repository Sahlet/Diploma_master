...
namespace My {
	...
	namespace BeeModel {
		...
		struct internal_model_data : public model_data {
			...
			int DailyForagingPeriod = 0;
			int DailyHoneyConsumption = 0;
			int DailyMiteFall = 0;
			int DailyPollenConsumption_g = 0;
			unsigned short day_number; //from 1 to DAYS_IN_YEAR //Day
			...
			int HoneyEnergyStore = 0;
			int HoneyEnergyStoreYesterday = 0;
